...
<html lang="es">
    <head>
        ...
        <title>EDITORIALES DE LIBROS</title>
    ...
    <body>
        ...
        <div class="container container-main">
            <h4 class="titulo-seccion">Nueva Editorial</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Nombre de la editorial">
            </div>

            <h4 class="titulo-seccion">Buscar Editorial</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Buscar por nombre">
            </div>

            <h4 class="titulo-seccion">Listado de Editoriales</h4>
            <table class="table table-hover">
                ...
                <tbody>
                    <!-- Aquí puedes insertar las editoriales con PHP -->
                </tbody>
            </table>
        </div>
