...
<html lang="es">
    <head>
        ...
        <title>CLASIFICACIONES DE LIBROS</title>
    ...
    <body>
        ...
        <div class="container container-main">
            <h4 class="titulo-seccion">Nueva Clasificación</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Nombre de la clasificación">
            </div>

            <h4 class="titulo-seccion">Buscar Clasificación</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Buscar por nombre">
            </div>

            <h4 class="titulo-seccion">Listado de Clasificaciones</h4>
            <table class="table table-hover">
                ...
                <tbody>
                    <!-- Aquí puedes insertar las clasificaciones con PHP -->
                </tbody>
            </table>
        </div>
