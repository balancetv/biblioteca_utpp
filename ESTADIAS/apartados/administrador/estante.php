...
<html lang="es">
    ...
    <body>
        ...
        <div class="container container-main">
            <h4 class="titulo-seccion">Nuevo Estante</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Nombre o número del estante">
            </div>

            <h4 class="titulo-seccion">Buscar Estante</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Buscar por nombre o número">
            </div>

            <h4 class="titulo-seccion">Listado de Estantes</h4>
            <table class="table table-hover">
                ...
                <tbody>
                    <!-- Aquí puedes insertar los estantes con PHP -->
                </tbody>
            </table>
        </div>
