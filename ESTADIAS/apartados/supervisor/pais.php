...
<html lang="es">
    ...
    <body>
        ...
        <div class="container container-main">
            <h4 class="titulo-seccion">Nuevo País</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Nombre del país..">
            </div>

            <h4 class="titulo-seccion">Buscar País</h4>
            <div class="mb-4">
                <input type="text" class="form-control" placeholder="Buscar por nombre">
            </div>

            <h4 class="titulo-seccion">Listado de Países</h4>
            <table class="table table-hover">
                ...
                <tbody>
                    <!-- Aquí puedes insertar los países con PHP -->
                </tbody>
            </table>
        </div>
